...
meta:
  ...
  description: This is the third in a series of tutorials accompanying our video demonstrations on getting started with Kubernetes. Part 3 explains why you should create a Load Balancer for your Kapsule cluster, and walks you through how to achieve this.
content:
  h1: Getting started with Kubernetes Part 3 - Load Balancers
  paragraph: This is the third in a series of tutorials accompanying our video demonstrations on getting started with Kubernetes. Part 3 explains why you should create a Load Balancer for your Kapsule cluster, and walks you through how to achieve this.
...
<Navigation title="See also">
  ...
  <NextButton to="/tutorials/get-started-kubernetes-storage/">Getting started with Kubernetes Part 4 - Storage</PreviousButton>
</Navigation>