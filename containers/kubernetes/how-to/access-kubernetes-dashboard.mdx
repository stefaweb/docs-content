...
<Navigation title="See also">
  <PreviousButton to="/containers/kubernetes/how-to/monitor-cluster/">How to monitor a Kubernetes Kapsule cluster with Cockpit</PreviousButton>
  <NextButton to="/containers/kubernetes/how-to/upgrade-cluster-node-image/">How to upgrade your cluster node images</NextButton>
</Navigation>
