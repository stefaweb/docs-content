...
You can view your Edge Services metrics via [Scaleway Cockpit](/observability/cockpit/quickstart/). This allows you to monitor your ingress, egress, request rate and cache hit ratio as well as other metrics. There are three steps to complete to view your Edge Services metrics for the first time with Cockpit:

1. TODO: IS THERE AN INTEGRATION FROM EDGE SERVICES DASHBOARD?
...
- Cache hit/miss
- Edge Services throughput
- Edge Services response statuses
- End users location
