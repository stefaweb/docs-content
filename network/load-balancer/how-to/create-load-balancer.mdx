...
6. Select the **accessibility** of your Load Balancer. Choose either:
    ...
    - **Public**: A public Load Balancer is accessible from the internet via its public IP address. You must choose from the following IP options:
        ...
        - **IPv6**: You can optionally add a public [IPv6](/network/load-balancer/concepts/#ipv6) address in addition to the IPv4 address. You can either allocate a new IPv4 address, or select one of your [existing flexible IPv4 addresses](/network/load-balancer/how-to/create-manage-flex-ips/).
