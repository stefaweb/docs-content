...
5. Select a **protocol** for the flexible IP address: either IPv4 or IPv6.

6. Optionally, choose a Load Balancer to attach the IP address to.

    <Message type="note">
    A Load Balancer cannot have more than one IPv4 and one IPv6 address at a time.
    </Message>

7. Check the estimated cost, and click **Create flexible IP**.
