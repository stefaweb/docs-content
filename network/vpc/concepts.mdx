...
<Message type="note">
This feature is currently in public beta, and available only when you create a new VPC.
</Message>
...
Read more about how routing works in the [route table](#route-table) concept.
