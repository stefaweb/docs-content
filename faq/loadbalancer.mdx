...
Yes, Load Balancer supports both IPv4 and IPv6 addresses at the public frontend. IPv6 can also be used to communicate between the Load Balancer and your backend servers.
