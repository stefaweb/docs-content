...
## Do Load Balancers support IPv6 addresses?

Yes, IPv6 addresses are now supported for Scaleway Load Balancers at the frontend. Every [public](/network/load-balancer/concepts/#accessibility) Load Balancer must have an IPv4 address, but an IPv6 address can also be added. You add an IPv6 address either when you [create the Load Balancer](/network/load-balancer/how-to/create-load-balancer/), or by [creating a new flexible IPv6 address](/network/load-balancer/how-to/create-manage-flex-ips/) and then attaching it to an existing Load Balancer.

IPv6 can also be used to communicate between the Load Balancer and your backend servers.
